...
export default (store) => {
  ...
  const objForWebViewerUI = {
    ...
    NotesPanel: {
      ...
      setNoteStatusTagArea: setNoteStatusTagArea(store),
      setNotePanelAnnotationInfo: setNotePanelAnnotationInfo(store),
      setNotePanelDocumentInfo: setNotePanelDocumentInfo(store),
      setNoteButtonArea: setNoteButtonArea(store),
